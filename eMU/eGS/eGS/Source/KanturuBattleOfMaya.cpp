...
#include "..\Header\KanturuBattleOfMaya.h"
...
BOOL CKanturuBattleOfMaya::LoadData(LPSTR lpszFileName)
{
	...
	try
	{
		...
		while ( true )
		{
			...
			while ( true )
			{
				...
				else if ( iType == 6 )
				{
					...
					LogAdd("[ KANTURU ][ BattleOfMaya ] IceStorm Using Rate Load: %d",
		...
		fclose(SMDFile);
		LogAdd( "[ KANTURU ][ BattleOfMaya ] %s file is Loaded",
			lpszFileName);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> NONE",
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> STANBY1",
		this->m_iBattleOfMayaState);
	LogAdd("[ KANTURU ][ BattleOfMaya ] State(%d) -> STANBY1",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> NOTIFY1",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> START1",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> MAYA1",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> END_MAYA1",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> ENDCYCLE_MAYA1",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> STANBY2",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> MAYA2",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> END_MAYA2",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> STANBY3",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> START3",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> MAYA3",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> ENDCYCLE_MAYA3",
		this->m_iBattleOfMayaState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfMaya ] State(%d) -> ENDCYCLE",
		this->m_iBattleOfMayaState);
	...
	if ( this->GetBattleSceneState() != -1 )
	{
		...
		if ( this->m_BattleTimeInfo[this->m_iSceneState].IsTimeOut() == TRUE )
		{
			if ( this->GetBattleOfMayaState() != KANTURU_MAYA_END )
			{
				...
				LogAdd("[ KANTURU ][ BattleOfMaya ] Fail!! TimeOut - DetailState:%d",
					this->m_iBattleOfMayaState);
...
void CKanturuBattleOfMaya::CheckMayaBattleUser()
{
		 ...
		 this->GetBattleOfMayaState() == KANTURU_MAYA3 )
	{
		if ( g_KanturuBattleUserMng.IsEmpty() == TRUE )
		{
			...
			LogAdd("[ KANTURU ][ BattleOfMaya ] Fail!! All Battle User Die - DetailState:%d",
				this->m_iBattleOfMayaState);
