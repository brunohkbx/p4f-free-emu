...
void CMapItem::CreateItem(int type, int level, int x, int y, double dur, BYTE Option1, BYTE Option2, BYTE Option3, BYTE NOption, BYTE SOption, DWORD number, BYTE ItemEffectEx)
{
	this->Init();
...
void CMapItem::DropCreateItem(int type, int level, int x, int y, double dur, BYTE Option1, BYTE Option2, BYTE Option3, BYTE NOption, BYTE SOption, DWORD number, int PetLevel, int PetExp, BYTE ItemEffectEx)
{
	this->Init();
