...
void JGServerLoginResult( SDHP_RESULT * lpMsg)	
{
	...
	{
		LogAdd("Authentication error from authentication server");
		return;
	}
...
void JGAnsMapSvrMove(PMSG_ANS_MAPSVRMOVE * lpMsg)
{
	...
	else
	{
		...
		TNotice::MakeNoticeMsgEx(&pNotice, 0, "Warping to that specific location is unavailable at the moment.");
