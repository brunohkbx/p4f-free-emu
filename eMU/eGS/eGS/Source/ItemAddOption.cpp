...
//	GS-CS	1.00.18	JPN	0x00508C40	-	Completed
//////////////////////////////////////////////////////////////////////
...
void CItemAddOption::Load(PCHAR chFileName)
{
	...
	if ( fopen_s(&SMDFile,chFileName, "r") != 0 )
	{
		return;
	}
...
bool CItemAddOption::_SetItemEffect(LPOBJ lpObj, int iEffectType, int iEffectValue)
{
	...
	switch ( iEffectType )
	{
		...
		case ADD_OPTION_MANA:
			...
			GCManaSend(lpObj->m_Index, short(lpObj->AddMana + lpObj->MaxMana), -2, 0, lpObj->MaxBP + lpObj->AddBP);
