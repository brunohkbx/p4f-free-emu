...
//	GS-CS	1.00.18	JPN	0x0051FE00	-	Completed
...
int  gOldScrollDropRate;
int  gCovenantOfIllusionDropRate;
...
void LoadGoldenConfigs(char *str)
{
	...
	{
		MsgBox("Blood Castle data load error %s", str);
		return;
	}
...
/*		case 6: // Phillipine
	...
	SetDlgItemText(hPageDlg3,IDC_EDIT1,UserCount);
	...
	LogAdd(lMsg.Get(413), gItemDropPer);
	...
	g_DarkHorseMixSuccessRate=GetPrivateProfileInt("GameServerInfo","DarkRavenMixSuccessRate",60, gDirPath.GetNewPath("commonserver.cfg"));
	...
	GetPrivateProfileString("GameServerInfo","ReloadOnlyForGMError","Only Game Masters can use this command",g_RoloadOnlyForGMError,sizeof(g_DropOnlyForGMError),gDirPath.GetNewPath("commonserver.cfg"));
	...
	GetPrivateProfileString("GameServerInfo","AddNotEnoughLvlError","You need more levles to use this command",g_AddNotEnoughLvl,sizeof(g_AddNotEnoughLvl),gDirPath.GetNewPath("commonserver.cfg"));
	...
	g_ArmorOfGuardmenPrice=GetPrivateProfileInt("GameServerInfo","ArmorOfGuardmenPrice",5000,gDirPath.GetNewPath("commonserver.cfg"));//CC
...
void SetMapName()
{
	strcpy_s(gMapName[0],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,208)));
	strcpy_s(gMapName[1],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,209)));
	strcpy_s(gMapName[2],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,210)));
	strcpy_s(gMapName[3],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,211)));
	strcpy_s(gMapName[4],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,212)));
	strcpy_s(gMapName[5],sizeof(gMapName[0]), "Reserved");
	strcpy_s(gMapName[6],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,214)));
	strcpy_s(gMapName[7],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,213)));
	strcpy_s(gMapName[8],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,216)));
	strcpy_s(gMapName[9],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,217)));
	strcpy_s(gMapName[10],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,221)));
	strcpy_s(gMapName[11],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,222)));
	strcat_s(gMapName[11], "1");
	strcpy_s(gMapName[12],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,222)));
	strcat_s(gMapName[12], "2");
	strcpy_s(gMapName[13],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,222)));
	strcat_s(gMapName[13], "3");
	strcpy_s(gMapName[14],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,222)));
	strcat_s(gMapName[14], "4");
	strcpy_s(gMapName[15],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,222)));
	strcat_s(gMapName[15], "5");
	strcpy_s(gMapName[16],sizeof(gMapName[0]), lMsg.Get(MSGGET(7,222)));
	...
	switch(eEventType)
	{
		case 0: //All Events
			...
			g_bCandyBoxEvent = GetPrivateProfileInt("GameServerInfo","CandyBoxEvent",0, gDirPath.GetNewPath("commonserver.cfg"));
                ...
                //Illusion Temple Ticket Items
                gOldScrollDropRate = GetPrivateProfileInt("GameServerInfo","OldScrollDropRate", 10, gDirPath.GetNewPath("commonserver.cfg"));
                gCovenantOfIllusionDropRate = GetPrivateProfileInt("GameServerInfo","CovenantOfIllusionDropRate", 10, gDirPath.GetNewPath("commonserver.cfg"));
