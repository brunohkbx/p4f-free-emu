...
public:
	...
	void Clear();
	void SetCastleOwnerGuild(std::string GuildName);
	...
	std::string GetCastleOwnerGuild(){return this->m_szCastleOwnerGuild;};	// line : 85
...
private:
	...
	std::string m_szCastleOwnerGuild;	// 18
