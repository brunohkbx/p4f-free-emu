...
public:
	...
	void Init() // line : 125
	{
		...
		{
			this->nCmdCode[n] = -1;	// #error Change the Zero for n
		}
	...
	{
		strcpy_s(this->szCmd[this->count],sizeof(this->szCmd[this->count]), command_str);
...
public:
	...
	void BattleInfoSend(std::string Name1, BYTE score1, std::string Name2, BYTE score2);
