...
void classdef::SetCharacter(int Class, int Str, int Dex, int Vit, int Energy, double Life, double Mana, double LevelLife, double LevelMana, double VitalityToLife, double EnergyToMana, int Leadership)
{
...
//что будет на чаре когда он начинает игру
void classdef::SetEquipment(int Class)
{
	int def_type=0;
	int right_type=0;

	for (int n=0;n<MAX_PLAYER_EQUIPMENT+1;n++)
	{
