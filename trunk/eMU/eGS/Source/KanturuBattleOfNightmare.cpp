...
#include "..\Header\KanturuBattleOfNightmare.h"
...
BOOL CKanturuBattleOfNightmare::LoadData(LPSTR lpszFileName)
{
	...
	try
	{
		...
		LogAdd( "[ KANTURU ][ BattleOfNightmare ]  %s file is Loaded",
			lpszFileName);
...
void CKanturuBattleOfNightmare::SetState(int iBattleOfNightmareState)
{
	...
	LogAdd("[ KANTURU ][ BattleOfNightmare ] CKanturuBattleOfNightmare::SetState(...)  m_iNightmareObjIndex %d",
...
{
	LogAdd( "[ KANTURU ][ BattleOfNightmare ] State(%d) -> NONE",
		this->m_iBattleOfNightmareState);

	this->SetBattleOfNightmareState(KANTURU_NIGHTMARE_NONE);
	TMonsterAIGroup::DelGroupInstance(this->m_iNightmareAIGroupNumber);

	LogAdd("[ KANTURU ][ BattleOfNightmare ] DelGroupInstance SetState_NONE");
}


void CKanturuBattleOfNightmare::SetState_IDLE()
{
	LogAdd( "[ KANTURU ][ BattleOfNightmare ] State(%d) -> IDLE",
		this->m_iBattleOfNightmareState);
	...
	LogAdd("[ KANTURU ][ BattleOfNightmare ] DelGroupInstance SetState_IDLE");
...
{
	LogAdd( "[ KANTURU ][ BattleOfNightmare ] State(%d) -> NOTIFY",
		this->m_iBattleOfNightmareState);
...
{
	LogAdd( "[ KANTURU ][ BattleOfNightmare ] State(%d) -> START",
		this->m_iBattleOfNightmareState);
	...
	LogAdd("[ KANTURU ][ BattleOfNightmare ] CKanturuNightmare Set m_iNightmareObjIndex %d",
		this->m_iNightmareObjIndex);
}
...
void CKanturuBattleOfNightmare::ProcState_START()
{
	...
	if ( gObj[iIndex].Live == FALSE )
	{
		...
		LogAdd("[ KANTURU ][ BattleOfNightmare ] Success!! Nightmare Die");
...
void CKanturuBattleOfNightmare::ProcState_ENDCYCLE()
{
	...
	LogAdd("[ KANTURU ][ BattleOfNightmare ] DelGroupInstance ProcState_ENDCYCLE");
}
...
void CKanturuBattleOfNightmare::CheckNightmareBattleUser()
{
		 ...
		 this->GetBattleOfNightmareState() == KANTURU_NIGHTMARE_START )
	{
		if ( g_KanturuBattleUserMng.IsEmpty() == TRUE )
		{
			...
			LogAdd("[ KANTURU ][ BattleOfNightmare ] Fail!! All Battle User Die");
