...
void CGLevelUpPointAdd(PMSG_LVPOINTADD* lpMsg, int aIndex, int count);
...
void GCGoalSend(int aIndex, std::string Name1, unsigned char score1, std::string Name2, unsigned char score2);
