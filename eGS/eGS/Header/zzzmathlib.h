...
void VectorRotate (const double in1[3*4],const double in2[3*4],double out[3*4]);
void AngleMatrix (const double *angles, double (*matrix)[4] );



/*typedef	double	vec3_t[3];	// x,y,z
typedef	double	vec4_t[4];	// x,y,z,w
*/
