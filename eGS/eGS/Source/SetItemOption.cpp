	...
	while ( true )
	{
		...
		if (Token == 1)
		{
			...
			while ( true )
			{
				...
				Token = WzMemScript.GetToken();
				number2 = (int)WzMemScript.GetNumber();
				...
				else
				{
					...
					Token=WzMemScript.GetToken();
					pointer->OptionIndex[0] = (int)WzMemScript.GetNumber();
					Token=WzMemScript.GetToken();
					pointer->OptionIndex[1] = (int)WzMemScript.GetNumber();
					Token=WzMemScript.GetToken();
					pointer->ChaosMixLevel[0] = (int)WzMemScript.GetNumber();
					Token=WzMemScript.GetToken();
					pointer->ChaosMixLevel[1] = (int)WzMemScript.GetNumber();
...
BOOL CSetItemOption::LoadOptionInfo(LPSTR Buffer, int iSize)
{
	...
	{
		Token=WzMemScript.GetToken();
		int number = (int)WzMemScript.GetNumber();
		...
		else
		{
			...
			{
				Token=WzMemScript.GetToken();
				p->SetOptionTable[i][0] = (int)WzMemScript.GetNumber();
				Token=WzMemScript.GetToken();
				p->SetOptionTableValue[i][0] = (int)WzMemScript.GetNumber();

				Token=WzMemScript.GetToken();
				p->SetOptionTable[i][1] = (int)WzMemScript.GetNumber();
				Token=WzMemScript.GetToken();
				p->SetOptionTableValue[i][1] = (int)WzMemScript.GetNumber();
			...
			// Special Set Item Options
			Token=WzMemScript.GetToken();
			p->SetExPOptionTable[0]  = (int)WzMemScript.GetNumber();
			Token=WzMemScript.GetToken();
			p->SetExPOptionTableValue[0] = (int)WzMemScript.GetNumber();
			...
			Token=WzMemScript.GetToken();
			p->SetExPOptionTable[1]  = (int)WzMemScript.GetNumber();
			Token=WzMemScript.GetToken();
			p->SetExPOptionTableValue[1] = (int)WzMemScript.GetNumber();
			...
			// Full Type Set Item
			Token=WzMemScript.GetToken();
			p->SetFullOtionTable[0] = (int)WzMemScript.GetNumber();
			Token=WzMemScript.GetToken();
			p->SetFullOtionTableValue[0] = (int)WzMemScript.GetNumber();

			Token=WzMemScript.GetToken();
			p->SetFullOtionTable[1] = (int)WzMemScript.GetNumber();
			Token=WzMemScript.GetToken();
			p->SetFullOtionTableValue[1] = (int)WzMemScript.GetNumber();

			Token=WzMemScript.GetToken();
			p->SetFullOtionTable[2] = (int)WzMemScript.GetNumber();
			Token=WzMemScript.GetToken();
			p->SetFullOtionTableValue[2] = (int)WzMemScript.GetNumber();

			Token=WzMemScript.GetToken();
			p->SetFullOtionTable[3] = (int)WzMemScript.GetNumber();
			Token=WzMemScript.GetToken();
			p->SetFullOtionTableValue[3] = (int)WzMemScript.GetNumber();

			Token=WzMemScript.GetToken();
			p->SetFullOtionTable[4] = (int)WzMemScript.GetNumber();
			Token=WzMemScript.GetToken();
			p->SetFullOtionTableValue[4] = (int)WzMemScript.GetNumber();

			// Save Character Class Disponibility
			Token=WzMemScript.GetToken();
			p->RequireClass[CLASS_WIZARD] = (BYTE)WzMemScript.GetNumber();

			Token=WzMemScript.GetToken();
			p->RequireClass[CLASS_KNIGHT] = (BYTE)WzMemScript.GetNumber();

			Token=WzMemScript.GetToken();
			p->RequireClass[CLASS_ELF] = (BYTE)WzMemScript.GetNumber();

			Token=WzMemScript.GetToken();
			p->RequireClass[CLASS_MAGUMSA] = (BYTE)WzMemScript.GetNumber();

			Token=WzMemScript.GetToken();
			p->RequireClass[CLASS_DARKLORD] = (BYTE)WzMemScript.GetNumber();
...
int CSetItemOption::GenRandomItemNum()
{
	...
	do
	{
		int type = Random(0,MAX_TYPE_ITEMS);
